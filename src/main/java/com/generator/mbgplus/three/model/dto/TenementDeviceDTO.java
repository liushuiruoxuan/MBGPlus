package com.generator.mbgplus.three.model.entity;
...
*/
@Data
@ApiModel(value = "TenementDeviceDTO对象", description = "3号楼空调设备")
public class TenementDeviceDTO implements Serializable {
